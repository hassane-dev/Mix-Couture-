<?php
// app/views/measurements/create.php
use App\Core\Session;

// $client variable is passed from MeasurementController::create()
...
if (!isset($client) || !$client) {
    echo "<div class='alert alert-danger container mt-5'>Error: Client data is missing. Cannot render create form. <a href='" . BASE_URL . "/clients'>Go back to client list.</a></div>";
    return;
}
?>
...
<head>
    ...
    <title>Add Measurements for <?php echo htmlspecialchars($client['FullName']); ?> - Fashion Platform</title>
    ...
    <div class="container mt-5">
        <div class="card shadow-sm">
            <div class="card-header">
                <h1 class="h3 mb-0">Add New Measurement Set for: <?php echo htmlspecialchars($client['FullName']); ?></h1>
            </div>
            <div class="card-body">
                ...
                <form action="<?php echo BASE_URL; ?>/measurements/store/<?php echo htmlspecialchars($client['ClientID']); ?>" method="POST">
                    <?php
                        // $measurement is not set here (it's for edit view)
                        ...
                        $measurement = null; // Explicitly null for create form context

...
// $orders variable is passed from OrderController::index() via $data array
$orders = $data['orders'] ?? []; // Ensure $orders is an array, even if empty
                        ...
                        <?php foreach ($orders as $order): ?>
                            <tr>
                                ...
                                <td class="table-actions">
                                    ...
                                    <form action="<?php echo BASE_URL; ?>/orders/destroy/<?php echo $order['OrderID']; ?>" method="POST" onsubmit="return confirm('Are you sure you want to mark this order as deleted?');" style="display: inline-block;">
